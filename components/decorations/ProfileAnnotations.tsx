...
const noteClass =
  "absolute whitespace-nowrap font-[var(--font-handwriting)] text-lg leading-none text-foreground/32 dark:text-white/36"
...
export function ProfileAnnotations() {
  return (
    ...
    >
      ...
      <Arrow
        className="absolute -left-35 -top-11 h-17 w-32 -rotate-9 text-foreground/16 dark:text-white/22"
      ...
      <Arrow
        className="absolute left-14 -top-13 h-18 w-34 rotate-8 text-foreground/16 dark:text-white/22"
      ...
      <Arrow
        className="absolute left-13 top-0 h-13 w-34 -rotate-2 text-foreground/16 dark:text-white/22"
      ...
      <Arrow
        className="absolute left-12 top-8 h-17 w-34 rotate-10 text-foreground/16 dark:text-white/22"
      ...
      <Arrow
        className="absolute -left-38 top-7 h-17 w-34 -rotate-5 text-foreground/16 dark:text-white/22"
